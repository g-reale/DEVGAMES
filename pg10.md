...
Para controlar o fluxo de execução/passagem de escopo, será implementado um símbolo de cadeia vazia ($\epislon$). Quando esse símbolo é escrito em uma aresta não ocorre troca de escopo com o nó conectado.

asd

> linha 1 do nó 0 esta sendo executada

asd

> controle passa para o nó 1
